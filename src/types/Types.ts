...
export interface CreateStateOnOnaylarimApiRequest {
  ...
  export interface CreateStateOnOnaylarimApiForPadesRequestV2 {
  /**
   * <summary>
   * Son kullanıcı bilgisayarında bulunan e-İmza Aracı vasıtasıyla alınan, e-imza atarken kullanılacak sertifikadır
   * </summary>
  ...
  export interface FinishSignForPadesRequestV2 {
  /**
   * <summary>
  ...
  export interface AddVerificationInfoCoreRequest {
  /**
   * <summary>
   * Her bir istek için tekil bir GUID değeri verilmelidir. Bu değer aynı e-imza işlemi ile ilgili olarak daha sonraki metodlarda kullanılır.
   * </summary>
   ...
   * </summary>
   */
    verificationInfo: VerificationInfoInner;
  /**
   * <summary>
   * İmzalanacak doküman üzerinde eklenecek QRCode ilgili bilgileri içerir
   * </summary>
   */
    qrCodeInfo: QrCodeInfoInner;
  }
  
  
  
  export interface QrCodeInfoInner {
  /**
   * <summary>
  ...
  export interface VerificationInfoInner {
  /**
   * <summary>
  ...
  // Generated by xxx.ps1 on 2025-12-05 14:05:30
